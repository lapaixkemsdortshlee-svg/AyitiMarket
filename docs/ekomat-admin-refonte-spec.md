...
| # | Contrainte | Détail |
|---|---|---|
| C1 | **Rien de supprimé** | Toute fonctionnalité admin existante reste accessible. Tu déplaces et tu réorganises, tu ne retires pas. Seule exception cadrée : l'onglet Kòmand, voir section 4. |
